...
<div class="page form-page">
    ...
    <form method="POST" action="<?= config('app.url') ?>/drivers/store" class="form-card">
        ...
        <table class="form-table">
            ...
            <tr><td>Passport Issue Date</td><td><input type="date" name="passport_issue_date" value="<?= e($old['passport_issue_date'] ?? '') ?>"><div id="error-passport_issue_date" class="error"><?= e($errors['passport_issue_date'] ?? '') ?></div></td></tr>
            ...
            <tr><td>License Issue Date</td><td><input type="date" name="license_issue_date" value="<?= e($old['license_issue_date'] ?? '') ?>"><div id="error-license_issue_date" class="error"><?= e($errors['license_issue_date'] ?? '') ?></div></td></tr>
