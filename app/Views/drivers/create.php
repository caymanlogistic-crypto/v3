...
<div class="page form-page">
    ...
    <form method="POST" action="<?= config('app.url') ?>/drivers/store" class="form-card">
        ...
        <table class="form-table">
            ...
            <tr><td><span class="form-label"><span class="form-label-text">Full Name</span><button type="button" class="form-help-button" data-help="Р’РІРµРґРёС‚Рµ С„Р°РјРёР»РёСЋ, РёРјСЏ Рё РѕС‚С‡РµСЃС‚РІРѕ РїРѕР»РЅРѕСЃС‚СЊСЋ.">?</button></span></td><td><input type="text" name="full_name" value="<?= e($old['full_name'] ?? '') ?>"><div class="form-hint">РџСЂРёРјРµСЂ: РРІР°РЅРѕРІ РРІР°РЅ РРІР°РЅРѕРІРёС‡</div><div id="error-full_name" class="error"><?= e($errors['full_name'] ?? '') ?></div></td></tr>
            <tr><td><span class="form-label"><span class="form-label-text">Phone</span><button type="button" class="form-help-button" data-help="РњРѕР¶РЅРѕ РІСЃС‚Р°РІР»СЏС‚СЊ РЅРѕРјРµСЂ РІ Р»СЋР±РѕРј С„РѕСЂРјР°С‚Рµ, С„РѕСЂРјР° РЅРѕСЂРјР°Р»РёР·СѓРµС‚ РµРіРѕ.">?</button></span></td><td><input type="text" name="phone" value="<?= e($old['phone'] ?? '') ?>"><div class="form-hint">РњРѕР¶РЅРѕ РІСЃС‚Р°РІРёС‚СЊ: 8 (999) 123-45-67</div><div id="error-phone" class="error"><?= e($errors['phone'] ?? '') ?></div></td></tr>
            <tr><td><span class="form-label"><span class="form-label-text">Email</span><button type="button" class="form-help-button" data-help="Р Р°Р±РѕС‡Р°СЏ РїРѕС‡С‚Р° РІРѕРґРёС‚РµР»СЏ РґР»СЏ СЃРІСЏР·Рё Рё РґРѕРєСѓРјРµРЅС‚РѕРІ.">?</button></span></td><td><input type="text" name="email" value="<?= e($old['email'] ?? '') ?>"><div class="form-hint">РџСЂРёРјРµСЂ: test@test.ru</div><div id="error-email" class="error"><?= e($errors['email'] ?? '') ?></div></td></tr>

            <tr><th colspan="2" class="form-section-title">РџР°СЃРїРѕСЂС‚</th></tr>
            <tr><td>Passport Number</td><td><input type="text" name="passport_number" value="<?= e($old['passport_number'] ?? '') ?>"><div class="form-hint">10 С†РёС„СЂ</div><div id="error-passport_number" class="error"><?= e($errors['passport_number'] ?? '') ?></div></td></tr>
            ...
            <tr><td>Passport Issued By</td><td><input type="text" name="passport_issued_by" value="<?= e($old['passport_issued_by'] ?? '') ?>"></td></tr>

            <tr><th colspan="2" class="form-section-title">Р’РѕРґРёС‚РµР»СЊСЃРєРѕРµ СѓРґРѕСЃС‚РѕРІРµСЂРµРЅРёРµ</th></tr>
            <tr><td>License Number</td><td><input type="text" name="license_number" value="<?= e($old['license_number'] ?? '') ?>"><div class="form-hint">10 С†РёС„СЂ</div><div id="error-license_number" class="error"><?= e($errors['license_number'] ?? '') ?></div></td></tr>
