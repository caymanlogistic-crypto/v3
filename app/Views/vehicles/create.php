...
<div class="page form-page">
    ...
    <form method="POST" action="<?= config('app.url') ?>/vehicles/store" class="form-card">
        ...
        <table class="form-table">
            ...
            <tr><td>Body Volume (m3)</td><td><input type="text" name="body_volume" value="<?= e($old['body_volume'] ?? '') ?>"><div class="form-hint">&#1052;&#1086;&#1078;&#1085;&#1086;: 90,5</div><div id="error-body_volume" class="error"><?= e($errors['body_volume'] ?? '') ?></div></td></tr>
