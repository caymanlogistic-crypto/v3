...
<div class="page form-page">
    ...
    <div class="section form-section" style="margin-top: 40px;">
        ...
        <div class="upload-grid">
            <div class="upload-block"><h3 class="upload-title">&#1047;&#1072;&#1075;&#1088;&#1091;&#1079;&#1080;&#1090;&#1100; &#1057;&#1058;&#1057;</h3><form method="POST" action="<?= config('app.url') ?>/vehicles/<?= (int) $vehicle['id'] ?>/files/upload" class="vehicle-file-upload-form" enctype="multipart/form-data"><?= csrf_field() ?><input type="hidden" name="file_type" value="sts"><input type="file" name="files[]" multiple><div class="error file-error"></div><div style="margin-top: 12px;"><button type="submit" class="btn btn-primary">Upload STS</button></div></form></div>
            <div class="upload-block"><h3 class="upload-title">&#1047;&#1072;&#1075;&#1088;&#1091;&#1079;&#1080;&#1090;&#1100; &#1076;&#1080;&#1072;&#1075;&#1085;&#1086;&#1089;&#1090;&#1080;&#1095;&#1077;&#1089;&#1082;&#1091;&#1102; &#1082;&#1072;&#1088;&#1090;&#1091;</h3><form method="POST" action="<?= config('app.url') ?>/vehicles/<?= (int) $vehicle['id'] ?>/files/upload" class="vehicle-file-upload-form" enctype="multipart/form-data"><?= csrf_field() ?><input type="hidden" name="file_type" value="diagnostic_card"><input type="file" name="files[]" multiple><div class="error file-error"></div><div style="margin-top: 12px;"><button type="submit" class="btn btn-primary">Upload Diagnostic Card</button></div></form></div>
            <div class="upload-block"><h3 class="upload-title">&#1055;&#1088;&#1086;&#1095;&#1080;&#1077; &#1092;&#1072;&#1081;&#1083;&#1099;</h3><form method="POST" action="<?= config('app.url') ?>/vehicles/<?= (int) $vehicle['id'] ?>/files/upload" class="vehicle-file-upload-form" enctype="multipart/form-data"><?= csrf_field() ?><input type="hidden" name="file_type" value="other"><input type="file" name="files[]" multiple><div class="error file-error"></div><input type="text" name="comment" value="" style="margin-top:8px;" placeholder="&#1050;&#1086;&#1084;&#1084;&#1077;&#1085;&#1090;&#1072;&#1088;&#1080;&#1081; (&#1085;&#1077;&#1086;&#1073;&#1103;&#1079;&#1072;&#1090;&#1077;&#1083;&#1100;&#1085;&#1086;)"><div style="margin-top: 12px;"><button type="submit" class="btn btn-primary">Upload File</button></div></form></div>
        </div>
