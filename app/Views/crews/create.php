...
<div class="page form-page">
    ...
    <form method="POST" action="<?= config('app.url') ?>/crews/store" class="entity-form">
        <?= csrf_field() ?>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="field" style="grid-column: 1 / -1;">
                        ...
                        <textarea id="field-comment" name="comment" class="field-textarea" rows="3"><?= e((string) ($old['comment'] ?? '')) ?></textarea>
