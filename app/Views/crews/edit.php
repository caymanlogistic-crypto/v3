...
<div class="page form-page">
    <div class="page-header">
        <h1><?= "\u{0420}\u{0435}\u{0434}\u{0430}\u{043A}\u{0442}\u{0438}\u{0440}\u{043E}\u{0432}\u{0430}\u{043D}\u{0438}\u{0435} \u{0441}\u{0432}\u{044F}\u{0437}\u{043A}\u{0438}" ?> #<?= (int) ($crew['id'] ?? 0) ?></h1>
    </div>
    ...
    <form method="POST" action="<?= config('app.url') ?>/crews/<?= (int) ($crew['id'] ?? 0) ?>/update" class="form-card">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <select name="status">
                        <option value="active" <?= ($crew['status'] ?? 'active') === 'active' ? 'selected' : '' ?>><?= "\u{0410}\u{043A}\u{0442}\u{0438}\u{0432}\u{043D}\u{0430}" ?></option>
                        <option value="inactive" <?= ($crew['status'] ?? '') === 'inactive' ? 'selected' : '' ?>><?= "\u{041D}\u{0435}\u{0430}\u{043A}\u{0442}\u{0438}\u{0432}\u{043D}\u{0430}" ?></option>
                        <option value="archived" <?= ($crew['status'] ?? '') === 'archived' ? 'selected' : '' ?>><?= "\u{0410}\u{0440}\u{0445}\u{0438}\u{0432}" ?></option>
                    </select>
        ...
        <div class="form-actions" style="margin-top:20px;">
            <button type="submit" class="btn btn-primary"><?= "\u{0421}\u{043E}\u{0445}\u{0440}\u{0430}\u{043D}\u{0438}\u{0442}\u{044C}" ?></button>
